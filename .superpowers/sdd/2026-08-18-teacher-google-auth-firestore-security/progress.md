...
Task 8: fix round 2 complete — remaining overlapping same-user refresh → account replacement Important addressed with durable rendered auth identity and deterministic stale-generation coverage; Node 373 total/326 pass/47 emulator-only skip, Rules+Admin Emulator 421/421 pass; external release gates remain unchanged.
